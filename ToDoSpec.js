describe('Testing the functionality, this is the checklist', ()=>{
  ...
  beforeEach(function(){
    ...
    item = {
      id: 1,
      title: "get something 1",
      complete: false
     }
     item2 = {
      id: 2,
      title: "get something 2",
      complete: false
     }   
  })
...
describe('Testing DOM manipulation', function(){
  ...
  it('should trigger form and add item to todo array', function(){
    const form = document.createElement('form');
    form.innerHTML= `<input value="get something" placeholder="Add An Item" />
      <button type="submit" />`;
    ...
    expect(todo.todo[0].title).toEqual('get something')
  })
